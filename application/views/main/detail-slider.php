...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li><a href="#">Home</a></li>
      <li>&#187;</li>
      <li class="current"><?= $profile->judul ?></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
    <h1><?= $profile->judul ?></h1>
    <img src="<?= base_url('assets/img/slider/'.$profile->gambar) ?>" width="100%"  align="left" style="margin-right: 10px; border: 1px solid #CCC; padding: 3px; margin-bottom: 10px;" />
    <p><?= str_replace('assets/', base_url("").'assets/', $profile->isi) ?></p>
  </div>
</div>
<!-- ####################################################################################################### -->
