...
<table width="100%">
    <tr><td colspan="2">Nama Madrasah</td><td>: <?= $attr->nama ?></td></tr>
    <tr><td colspan="2">Desa/Kecamatan</td><td>: <?= $attr->kelurahan.'/'.$attr->kecamatan ?></td></tr>
    <tr><td colspan="2">Kabupaten</td><td>: <?= $attr->kabupaten ?></td></tr>
    <tr><td colspan="2">Provinsi</td><td>: <?= $attr->provinsi ?></td></tr>
</table>
<br/>
