...
<script type="text/javascript">
    $(function() {
        ...
        $('#cetak').click(function() {
            ...
            window.open('<?= base_url('laporan/print_buku_pembantu_kas/') ?>?'+$('#formsearch').serialize()+'&cetak=printer','Cetak Transaksi BANK','width='+dWidth+', height='+dHeight+', left='+x+',top='+y);
        });
        
        $('#excel_button').click(function() {
            location.href='<?= base_url('laporan/print_buku_pembantu_kas/') ?>?'+$('#formsearch').serialize()+'&cetak=excel';
        });
