...
function message_add_success() {
    ...
    (new PNotify({
        title: 'Informasi',
        text: 'Proses tambah data berhasil dilakukan !',
        desktop: {
            desktop: true
        }
    }));
...
function message_add_failed() {
    ...
    (new PNotify({
        title: 'Peringatan',
        text: 'Proses tambah data gagal dilakukan.',
        type: 'error',
        animate_speed: 'fast',
        desktop: {
            desktop: true
...
function message_edit_success() {
    PNotify.desktop.permission();
    (new PNotify({
        title: 'Informasi',
        text: 'Proses perubahan data berhasil dilakukan !',
        animate_speed: 'fast',
        desktop: {
            desktop: true
        }
...
function message_edit_failed() {
    ...
    (new PNotify({
        title: 'Peringatan',
        text: 'Proses edit data gagal dilakukan.',
        type: 'error',
        animate_speed: 'fast',
        desktop: {
            desktop: true
...
function message_delete_success() {
    ...
    (new PNotify({
        title: 'Informasi',
        text: 'Proses penghapusan data berhasil dilakukan !',
        animate_speed: 'fast',
        desktop: {
            desktop: true
        }
...
function message_delete_failed() {
    ...
    (new PNotify({
        title: 'Peringatan',
        text: 'Proses penghapus data gagal dilakukan.',
        type: 'error',
        animate_speed: 'fast',
        desktop: {
            desktop: true
...
function dinamic_message(title, text) {
    PNotify.desktop.permission();
    (new PNotify({
        title: title,
        text: text,
